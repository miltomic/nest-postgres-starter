...
export const migrationsTransactionMode = 'each';
...
export const entities = ['dist/com/milan-tomic/**/*.entity.ts'];
export const synchronize = false;
export const migrations = ['dist/com/milan-tomic/config/database/migration/**/*.ts'];
